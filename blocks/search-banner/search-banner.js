...
function renderResult(result, searchTerms, titleTag) {
  ...
  if (result.image) {
    ...
    wrapper.className = 'search-banner-result-image';
  ...
  if (result.title) {
    ...
    title.className = 'search-banner-result-title';
...
function clearSearchResults(block) {
  const searchResults = block.querySelector('.search-banner-results');
...
function searchBox(block, config) {
  ...
  box.classList.add('search-banner-box');
  box.append(
    searchIcon(),
...
export default async function decorate(block) {
  const placeholders = await import('../../scripts/placeholders.js').then((mod) => mod.fetchPlaceholders()).catch(() => ({}));
